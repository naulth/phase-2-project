    ...
    return(
        <div>
            ...
            <div className="aboutdiv">
                <p className="abouttext">The Science-Fiction and Fantasy Database is an ever growing collection of your favorite movies, books, and games, along with some titles you may have yet to discover.</p><br/>
